...
func (MockProvider) Snapshot(_ context.Context) (topology.Snapshot, error) {
	return topology.Snapshot{
		...
		Nodes: []topology.Node{
			...
			node("Pod", "platform", "kuviewer-api-6d9c4", "healthy", map[string]string{"app": "kuviewer"}, map[string]interface{}{"ready": true, "restarts": 0, "node": "worker-a", "containerNames": []string{"api"}, "initContainers": []string{"migrate"}}, 920, 260),
			...
			node("Pod", "checkout", "checkout-api-7c8f9", "warning", map[string]string{"app": "checkout"}, map[string]interface{}{"ready": false, "restarts": 4, "node": "worker-c", "containerNames": []string{"api", "sidecar"}}, 1080, 690),
