...
3. 업로드 모드 강화
   ...
   - 다음 확장 후보는 keychain-backed bearer-token profile runtime prototype 또는 desktop package smoke matrix 확장이다.
