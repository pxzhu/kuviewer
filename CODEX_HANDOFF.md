...
3. 업로드 모드 강화
   ...
   - Resource Explorer saved view sharing/export는 완료됐다.
   - 다음 확장 후보는 saved view server-side/team sharing 또는 resource explorer URL state sync다.
