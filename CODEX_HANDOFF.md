...
3. 업로드 모드 강화
   ...
   - 다음 확장 후보는 desktop sidecar source/profile 설정 UI 또는 keychain-backed cluster credential design이다.
