...
- 기본 UI 테마는 B번 브랜드 시안 기반의 dark graphite/radar topology 스타일이다. 공유 썸네일, favicon, apple-touch icon도 같은 radar asset 계열을 사용한다.
...
3. 업로드 모드 강화
   ...
   - Radar branding, link preview thumbnail, favicon/apple-touch icon, dark graphite UI theme은 완료됐다.
