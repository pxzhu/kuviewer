...
3. 업로드 모드 강화
   ...
   - 다음 확장 후보는 Windows desktop package workflow dry-run 또는 desktop remote server connection profile UX다.
