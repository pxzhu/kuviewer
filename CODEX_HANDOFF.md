...
3. 업로드 모드 강화
   ...
   - 다음 확장 후보는 desktop remote server connection profile UX, desktop release artifact/versioning polish, signing/notarization, local sidecar evaluation이다.
