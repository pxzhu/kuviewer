...
3. 업로드 모드 강화
   ...
   - 다음 확장 후보는 Resource Explorer detail search within safe preview 또는 CM/server connection UX 재검토다.
