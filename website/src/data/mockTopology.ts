...
export const mockTopology: TopologySnapshot = {
  ...
  nodes: [
    ...
    node(local, 'Deployment', 'checkout', 'checkout-api', 'warning', { app: 'checkout', tier: 'backend' }, { replicas: '2/3', containers: 2, initContainers: 0, imageCount: 2, images: ['checkout/api:mock', 'checkout/sidecar:mock'] }),
