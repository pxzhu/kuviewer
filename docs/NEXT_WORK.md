...
4. Desktop prototype scope reduction
   ...
   - Session group/card/bulk toolbar, saved-layout import conflict panel, folder/preset list는 표시 모듈로 분리됐다. 남은 saved-layout toolbar/controller를 더 분리할지, prototype archive로 축소할지 실제 사용 후 결정한다.
