...
4. Desktop prototype scope reduction
   ...
   - Session group/card/bulk toolbar와 saved-layout import conflict panel은 표시 모듈로 분리됐다. Saved-layout folder/preset list UI를 더 분리할지, prototype archive로 축소할지 실제 사용 후 결정한다.
